		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#logaligroupemployeemgmt-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligroupemployeemgmt-display": {
								"semanticObject": "logaligroupemployeemgmt",
								"action": "display",
								"description": "Employee management system in SAPUI5",
								"title": "Employee management system",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.employeemgmt",
									"url": sap.ui.require.toUrl("logaligroup/employeemgmt")
								}
							}
						}
					}
